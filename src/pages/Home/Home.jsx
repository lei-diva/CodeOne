...
import Blue from "../../images/app.png";
import firstslide from "../../images/firstslide.png";
import secondslide from "../../images/secondslide.png";
import loginss from "../../images/login-ss.png";
import profiless from "../../images/profile-ss.png";
      ...
      <div className="content">
        <section id="intro">
          <div className="intro-text">
            ...
            <div className="subtitle">
              Develop with HTML, CSS, and Javascript in your own virutal
              playground!
            </div>
            <a className="get-started" href={getStartedRoute}>
              <button className="home-button get-started">GET STARTED</button>
            </a>
          </div>
        ...
        >
          <path
            fill="white"
            fill-opacity="1"
            d="M0,128L80,138.7C160,149,320,171,480,149.3C640,128,800,64,960,48C1120,32,1280,64,1360,80L1440,96L1440,320L1360,320C1280,320,1120,320,960,320C800,320,640,320,480,320C320,320,160,320,80,320L0,320Z"
          ></path>
        </svg>
        ...
        <div className="signin-home">
          <section id="features">
            ...
            <Carousel interval={3000}>
              <Carousel.Item>
                <img className="videos" src={firstslide}></img>
              </Carousel.Item>
              <Carousel.Item>
                <img className="videos" src={secondslide}></img>
              </Carousel.Item>
              <Carousel.Item>
                <img className="videos" src={loginss}></img>
              </Carousel.Item>
              <Carousel.Item>
                <img className="videos" src={profiless}></img>
              </Carousel.Item>
            </Carousel>
          </section>
          ...
          <section id="blog-section">
            ...
            <div className="medium-blog">
              ...
              <h3>The Production of Code One</h3>
              <p>
              ...
              <p>
                Phasellus egestas tellus rutrum tellus pellentesque eu. Sed
                felis eget velit aliquet sagittis id. Neque viverra justo nec
                ultrices dui sapien eget mi. Enim sit amet venenatis urna
                cursus. Phasellus vestibulum lorem sed risus ultricies
                tristique. Aliquet nec ullamcorper sit amet risus nullam eget
                felis. Nibh praesent tristique magna sit amet purus gravida quis
                blandit. Ornare aenean euismod elementum nisi quis eleifend quam
                adipiscing vitae. Sagittis aliquam malesuada bibendum arcu.
                Nulla at volutpat diam ut venenatis tellus in metus. Amet tellus
                cras adipiscing enim. Erat imperdiet sed euismod nisi porta.
                Elit ullamcorper dignissim cras tincidunt lobortis. Mauris
                rhoncus aenean vel elit scelerisque mauris pellentesque.
                Maecenas ultricies mi eget mauris. Neque viverra justo nec
                ultrices. Rutrum tellus pellentesque eu tincidunt tortor aliquam
                nulla facilisi. Enim nulla aliquet porttitor lacus. Euismod
                lacinia at quis risus sed. Risus ultricies tristique nulla
                aliquet enim tortor. Vestibulum rhoncus est pellentesque elit
                ullamcorper dignissim. Vel turpis nunc eget lorem dolor sed
                viverra ipsum. Condimentum id venenatis a condimentum vitae
                sapien pellentesque habitant morbi. Amet cursus sit amet dictum
                sit amet justo donec enim. Tellus cras adipiscing enim eu turpis
                egestas pretium aenean pharetra. Morbi tristique senectus et
                netus et malesuada fames ac. Tortor condimentum lacinia quis
                vel. Nec feugiat in fermentum posuere. Felis bibendum ut
                tristique et egestas quis ipsum suspendisse. Tempor nec feugiat
                nisl pretium fusce id.
              </p>
              <p>
                Faucibus in ornare quam viverra orci sagittis eu volutpat odio.
                Quam viverra orci sagittis eu volutpat. Congue mauris rhoncus
                aenean vel elit scelerisque mauris. Aliquam faucibus purus in
                massa tempor. Neque sodales ut etiam sit amet. Lacus sed viverra
                tellus in hac habitasse platea. Venenatis lectus magna fringilla
                urna porttitor rhoncus dolor purus non. Faucibus interdum
                posuere lorem ipsum dolor sit amet consectetur. Est lorem ipsum
                dolor sit amet consectetur. In aliquam sem fringilla ut morbi
                tincidunt. Ultricies lacus sed turpis tincidunt id aliquet risus
                feugiat in. Scelerisque in dictum non consectetur a erat nam at.
                Dignissim enim sit amet venenatis urna cursus eget. Est ante in
                nibh mauris cursus. Consectetur purus ut faucibus pulvinar
                elementum integer. Nulla aliquet porttitor lacus luctus accumsan
                tortor posuere ac ut. Cursus in hac habitasse platea dictumst
                quisque sagittis. Consequat nisl vel pretium lectus quam id. A
                pellentesque sit amet porttitor eget dolor morbi non. Quis
